...
>- Roughly speaking, the PISE is the r.m.s. of ${x}_i\hat\beta-{x}_j\hat\beta$ among pairs $(i,j)$ s.t. ${x}_i\beta = {x}_j\beta$. 
>- If $p^2/n \downarrow 0$, then PISE $\stackrel{P}{\rightarrow} 0$, and matching within $k$ PISEs suffices for $\max_{i\sim j} |{x}_i\beta-{x}_j\beta| \stackrel{P}{\rightarrow} 0$.
