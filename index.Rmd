...
> - Implicitly, our (pseudo) metric is $d_{Y_{c}} (x, w) =  |E(Y_{c}|X=x) - E(Y_{c}|X=w)|$.  Or: $d_{Y_{t}} =  |E(Y_{t}|x) - E(Y_{t}|w)|$, $d_{Y_{c}} + d_{Y_{t}}$...
> - Or $d_{Z}(x, w)=|g(P(Z=1| X=x)) - g(P(Z=1| X=w))|$, $g(\cdot)$ increasing (cf. Rosenbaum & Rubin, 1983, or Rubin, 1997).
